...
static NSString *LeeStrokeAnimationKey   = @"mmmaterialdesignspinner.stroke";
static NSString *LeeRotationAnimationKey = @"mmmaterialdesignspinner.rotation";

@interface LeeRefreshLoadView()
...
@implementation LeeRefreshLoadView
...
- (void)startAnimating {
    ...
    [self.progressLayer addAnimation:animation forKey:LeeRotationAnimationKey];
    ...
    endHeadAnimation.fromValue = @(0.3f);
    ...
    [self.progressLayer addAnimation:animations forKey:LeeStrokeAnimationKey];
...
- (void)stopAnimating {
    ...
    [self.progressLayer removeAnimationForKey:LeeRotationAnimationKey];
    [self.progressLayer removeAnimationForKey:LeeStrokeAnimationKey];
